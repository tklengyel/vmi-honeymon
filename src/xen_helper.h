...
honeymon_xen_domconfig_raw_t* honeymon_xen_domconfig_raw_by_id(honeymon_xen_interface_t *xen, unsigned int domID);
void honeymon_xen_free_domconfig_raw(honeymon_xen_domconfig_raw_t* raw_config);
void honeymon_xen_save_domconfig(honeymon_t *honeymon, XLU_Config *config, char* path);
XLU_Config* honeymon_xen_parse_domconfig_raw(honeymon_xen_domconfig_raw_t* raw_config);
XLU_Config* honeymon_xen_domconfig_by_name(honeymon_xen_interface_t *xen, char* domain_name);
XLU_Config* honeymon_xen_domconfig_by_id(honeymon_xen_interface_t *xen, unsigned int domID);
