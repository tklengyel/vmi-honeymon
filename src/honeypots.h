...
honeymon_honeypot_t * honeymon_honeypots_init_honeypot(honeymon_t *honeymon, char *name);
honeymon_clone_t * honeymon_honeypots_init_clone(honeymon_t *honeymon, char *origin_name, char *clone_name, char *bridge_name);
honeymon_clone_t * honeymon_honeypots_find_clone(honeymon_t *honeymon, char *clone_name);
...
gboolean honeymon_honeypots_pause_clones2(gpointer key, gpointer value, gpointer data);
gboolean honeymon_honeypots_unpause_clones2(gpointer key, gpointer value, gpointer data);
